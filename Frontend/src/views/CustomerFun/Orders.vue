  ...
  setup() {
    ...
    const getOrderHeaderClass = (status) => {
      switch (status) {
        ...
        case 'CONFIRMED': return 'bg-info bg-opacity-25';
        case 'SHIPPED': return 'bg-primary bg-opacity-25';
    ...
    const getProgressBarClass = (status) => {
      ...
      // Example placeholder:
      try {
        // await axios.post(`http://localhost:8084/order-service/api/orders/cancel/${orderId}`, {}, {
        //   headers: getAuthHeaders()
        // });
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div v-else-if="!orders.length" class="text-center">
          ...
          <router-link to="/new-order" class="btn btn-primary">Place Your First Order</router-link>
        </div>
        <div v-else>
          <div class="mb-3">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p v-if="order.deliveryDate"><strong>Delivery Date:</strong> {{ formatDate(order.deliveryDate) }}</p>
                  </div>
                </div>
                ...
                <div v-if="expandedOrders.includes(order.id)" class="order-details mt-3">
                  <h6>Order Items</h6>
